// <copyright file="MeanAbsoluteDifference.cs">
...
// <summary>Class representing a MeanAbsoluteDifference.cs entity.</summary>
...
{
    /// <summary>
    /// Dispersion Measure for Relevance Filter using Mean Absolute Differebce
    ...
    /// </summary>
    public class MeanAbsoluteDifferenceFS : IDispersionMeasure
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MeanAbsoluteDifferenceFS"/> class.
        /// </summary>
        public MeanAbsoluteDifferenceFS()
        {
        ...
        public MeanAbsoluteDifferenceFS(Dataset dataset)
        {
            this.maxFeature = int.MaxValue;
        ...
        public MeanAbsoluteDifferenceFS(int maxFeature)
        {
            this.dataset = null;
        ...
        /// <param name="dataset">The dataset.</param>
        /// <param name="maxFeature">Maximum Number of Features to Keep</param>
        public MeanAbsoluteDifferenceFS(Dataset dataset, int maxFeature)
        {
            this.dataset = dataset;
            this.maxFeature = maxFeature;
        }
        ...
        private Dictionary<Variables, double> CalculateTermMark(Dataset tmpDataset)
        {
            ...
            for (int i = 0; i < tmpDataset.ListRow.Count; i++)
            {
                foreach (Variables var in tmpDataset.ListRow[i].InputValue.Keys)
                {
                    ...
                    termMark[var] += Math.Abs(value);
                }
            }

            for (int i = 0; i < tmpDataset.InputVariables.Count; i++)
            {
                termMark[tmpDataset.InputVariables[i]] /= Convert.ToDouble(tmpDataset.ListRow.Count);
            }
            return termMark;
        }
        #endregion
